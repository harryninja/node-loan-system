This app is built with nodeJs express framework and sql database. In the frontend i have used html css and bootstrap.
...
Customer info:
 ...
 Take the database from database folder and import the database to your database and keep the name same given in the file.
